const AIRHORN_URL = process.env.WEBSITE_BASE_URL ? String(process.env.WEBSITE_BASE_URL).trim() : "https://airhorn.solutions";
const AIRHORN_CLIENT_ID = process.env.WEBSITE_CLIENT_ID ? String(process.env.WEBSITE_CLIENT_ID).trim() : "159799960412356608";
...
export default {
  ...
  OAUTH2_ADD_URL: "https://discord.com/api/oauth2/authorize?client_id=" + AIRHORN_CLIENT_ID + "&permissions=36703232&scope=applications.commands%20bot",
  AIRHORN_URL,
